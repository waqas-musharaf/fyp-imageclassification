...
train_data = "C:\\Users\\Waqas\\Desktop\\New Datasets\\stanfordcar_dataset\\anno_train_vl.csv"
train_dataset = pd.read_csv(train_data, names=names)
train_array = train_dataset.values
valid_data = "C:\\Users\\Waqas\\Desktop\\New Datasets\\stanfordcar_dataset\\anno_test_vl.csv"
valid_dataset = pd.read_csv(valid_data, names=names)
valid_array = train_dataset.values

X_train = train_array[:,1:5]
Y_train = train_array[:,5]
X_valid = valid_array[:,1:5]
Y_valid = valid_array[:,5]
